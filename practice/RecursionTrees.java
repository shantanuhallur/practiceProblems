public class RecursionTrees {
    ...
    public static int coinChangeCombination_Sin_Sub(int[] coins, int tar, int idx, String psf) {
        ...
        if (tar - coins[i] >= 0) {
            count += coinChangeCombination_Sin(coins, tar - coins[idx], i + 1, psf + coins[idx] + " ");
        }
        count += coinChangeCombination_Sin(coins, tar, i + 1, psf);
    ...
    public static int coinChangePermutation_IN_Sub(int[] coins, int tar, int idx, String psf) {
        ...
        count += coinChangePermutation_IN_Sub(coins, tar - coins[idx], idx + 1, psf + coins[idx]);
    ...
    public static int coinChangeCombination_IN_Sub(int[] coins, int tar, int idx, String psf) {
        ...
        count += coinChangeCombination_IN_Sub(coins, tar - coins[idx], idx + 1, psf + coins[idx]);
